...
//     before(
//         async () =>
//             ({ GameStorage, EternalStorage, FHR, Sat, Solar, Treasury } = await protocol.deploy(
//                 accounts
//             ))
//     );
...
//                     web3.utils.soliditySha3('master.fleet.position.quadrant', UserA)
//                 ),
//                 EternalStorage.getUint8(
//                     web3.utils.soliditySha3('master.fleet.position.sector', UserA)
//                 ),
//                 EternalStorage.getUint8(
//                     web3.utils.soliditySha3('master.fleet.position.district', UserA)
//                 ),
//                 EternalStorage.getUint(web3.utils.soliditySha3('master.fleet.position.star', UserA))
//             ]);

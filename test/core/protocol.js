...
// const TestFhr = artifacts.require('../../contracts/testing/TestFederalHarvestingRights.sol');
// const TestSolar = artifacts.require('../../contracts/testing/TestSolar.sol');
// const TestSat = artifacts.require('../../contracts/testing/TestShipsAndTechnology.sol');
...
// const { WEAK_FLEET, AVERAGE_FLEET, STRONG_FLEET } = require('../lib/testValues.js');
// const deploy = async accounts => {
//     const EternalStorage = await EternalStorageC.new();

//     const [FHR, Solar] = await Promise.all([
...
//             web3.utils.soliditySha3('contract.exists' + GameOperationsC.address),
//             true
//         ),
//         EternalStorage.setBool(web3.utils.soliditySha3(`contract.exists${Treasury.address}`), true),
//         EternalStorage.setBool(web3.utils.soliditySha3(`contract.exists${FHR.address}`), true),
//         EternalStorage.setBool(web3.utils.soliditySha3(`contract.exists${Sat.address}`), true),
//         EternalStorage.setBool(web3.utils.soliditySha3(`contract.exists${Solar.address}`), true),
...
//             Treasury.address
//         ),
//         EternalStorage.setAddress(web3.utils.soliditySha3(`contract.address.fhr`), FHR.address),
//         EternalStorage.setAddress(web3.utils.soliditySha3(`contract.address.sats`), Sat.address),
//         EternalStorage.setAddress(web3.utils.soliditySha3(`contract.address.solar`), Solar.address),
//         EternalStorage.setBool(web3.utils.soliditySha3('fhr.access', Treasury.address), true),
//         EternalStorage.setAddress(
...
//     ]);
//     for (const account of accounts) {
//         await helpers.setAllowance(Solar, account, Treasury.address, 1000000000);
//     }

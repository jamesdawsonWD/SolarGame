...
// const { WEAK_FLEET, AVERAGE_FLEET, STRONG_FLEET } = require('./lib/testValuesCommon.js');
...
//     let GameOperations;
//     let GameStorage;
//     before(async () => ({ GameOperations, GameStorage } = await protocol.deploy(accounts)));
...
//                 const amount = await GameStorage.getMasterLockedInShipInfo(UserA, ids[i], {
//                     from: UserA
//                 });
